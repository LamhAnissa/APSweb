...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"  href="renverra sur une présentation de APS " >APS Serv.</a>
    </div>
...
<h2 style= "text-align:center">Authentification Client</h2>
  <br> </br>
<?php echo form_open('Client/validation'); ?>


  <div class="container">
    <label for="uname"><b>Identifiant</b></label>
    <input type="text" placeholder="Entrez votre Identifiant" name="ConnexionClient" required>
  ...
  <div class="container" style="background-color:#f1f1f1">
   <a href="Accueil.php"> <button type="button" class="cancelbtn">Annuler</button></a>
