            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="espaceperso.html"><i class="fa fa-dashboard fa-fw"></i> Mon espace perso</a>
                        </li>
                        ...
                        <li>
                            <a href="ficheclient.html"><i class="fa fa-edit fa-fw"></i> Informations personnelles</a>
                        </li>
                        <li>
