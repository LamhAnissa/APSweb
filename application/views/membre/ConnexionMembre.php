...
<h2 style= "text-align:center">Authentification Personnel</h2>
  <br> </br>


<?php echo form_open('Membre/validation'); ?>


  <div class="container">
    <label for="uname"><b>Identifiant</b></label>
    <input type="text" placeholder="Entrez votre Identifiant" name="mail" value="<?php echo set_value('mailito'); ?>" required/>

    <h6 style="color:blue;"><?php echo form_error('mailito'); ?></h6>

    <label for="psw"><b>Mot de passe</b></label>
    <input type="password" placeholder="Entrer votre mot de passe" name="password" required>
     <h5 style="color:blue;"><?php echo form_error('password'); ?></h5>  
